...
const successResponse = (data: any = [], msg: string = null): response => {
  if (msg == null) msg = 'OK';
  const resData = {
    error: false,
    code: 200,
...
const errorResponse = (err: any, code: number): response => {
...
const notFoundResponse = (msg: string): response => {
  return {
    error: true,
    code: 404,
    message: msg
...
const validationError = (data: any, msg: string = null): response => {
...
const unauthorizedResponse = (msg: string): response => {
  return {
    error: true,
    code: 401,
    message: msg
...
export { successResponse, errorResponse, notFoundResponse, validationError, unauthorizedResponse }